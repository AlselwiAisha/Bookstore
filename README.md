...
**"Bookstore"** is a project that lays the foundations for the Bookstore website. Create the user interface using React
...
- [Copy & Paste] git clone https://github.com/AlselwiAisha/Bookstore.git
...
- git clone https://github.com/AlselwiAisha/Bookstore.git
...
Feel free to check the [issues page](https://github.com/AlselwiAisha/Bookstore/issues).
